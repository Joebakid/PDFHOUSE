...
function Nav({ Btn, LinkCustom }) {
  ...
  return (
    <nav
      className="relative w-[90%] flex flex-col items-center justify-between 
  px-6 py-4 text-xs text-black transition duration-300 
  bg-gray-100 rounded-lg shadow-md mx-auto 
  dark:bg-gray-800 max-w-7xl md:flex-row dark:text-white md:mt-6"
    >
      {/* Logo + Mobile Icons */}
